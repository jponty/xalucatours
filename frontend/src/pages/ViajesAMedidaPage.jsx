    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Para confirmar la sesión, solo deberás añadir tu nombre, apellido(s), correo electrónico, teléfono y la fecha y hora deseadas. Del resto se encarga el equipo de Xaluca Tours.",
        },
      ],
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "To confirm the session you only need to share your first name, last name(s), email, phone and the desired day and time. The Xaluca Tours team takes care of the rest.",
        },
      ],
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Pour confirmer, il suffit d'indiquer votre prénom, nom de famille, email, téléphone et la date / heure souhaitées. L'équipe Xaluca Tours s'occupe du reste.",
        },
      ],
