...
const COPY = {
  ...
  hero: {
    ...
    place:   { es: "España · Marruecos", en: "Spain · Morocco", fr: "Espagne · Maroc" },
    title: {
    ...
    subtitle: {
      es: "Un equipo multicultural entre dos países, con conocimiento local, experiencia en el destino y una pasión compartida por mostrar Marruecos desde una perspectiva cercana y exclusiva.",
      en: "A multicultural team between two countries, with local knowledge, on-the-ground experience and a shared passion for showing Morocco from a close-up, exclusive perspective.",
      fr: "Une équipe multiculturelle entre deux pays, riche d'une connaissance locale, d'une expérience sur le terrain et d'une passion commune pour faire découvrir le Maroc de manière proche et exclusive.",
    },
  },
  intro: {
    ...
    p2: {
      es: "Operamos tanto en España como en Marruecos, conectando ambos países a través de un equipo multicultural que trabaja cada día para crear viajes únicos, auténticos y memorables. Más que organizar viajes, creemos en crear experiencias que permitan descubrir Marruecos de una forma profunda, humana y transformadora.",
      en: "We operate from both Spain and Morocco, connecting the two countries through a multicultural team that works every day to craft unique, authentic and memorable journeys. More than organising trips, we believe in creating experiences that reveal Morocco in a deep, human and transformative way.",
      fr: "Nous opérons à la fois en Espagne et au Maroc, en reliant les deux pays grâce à une équipe multiculturelle qui œuvre chaque jour à façonner des voyages uniques, authentiques et mémorables. Plus que des voyages, nous croyons à des expériences qui révèlent le Maroc de manière profonde, humaine et transformatrice.",
    },
  },
  group: {
  ...
  bridge: {
    overline: { es: "Dos países, un mismo equipo", en: "Two countries, one team", fr: "Deux pays, une seule équipe" },
    title: {
      es: "Operamos entre España y Marruecos — para que nada se pierda en el camino.",
      en: "We operate between Spain and Morocco — so nothing is lost in translation.",
      fr: "Nous opérons entre l'Espagne et le Maroc — pour que rien ne se perde en chemin.",
    },
    columns: [
      { id: "spain",   icon: "Globe2",   flag: "🇪🇸",
        title: { es: "España · Sabadell (Barcelona)", en: "Spain · Sabadell (Barcelona)", fr: "Espagne · Sabadell (Barcelone)" },
        body:  { es: "Oficina comercial y agentes de viaje que diseñan tu propuesta, gestionan reservas y te acompañan antes, durante y después del viaje.",
                 en: "Sales office and travel agents who design your proposal, manage bookings and accompany you before, during and after your trip.",
                 fr: "Bureau commercial et conseillers qui conçoivent votre proposition, gèrent les réservations et vous accompagnent avant, pendant et après le voyage." } },
      { id: "morocco", icon: "Compass",  flag: "🇲🇦",
        ...
        body:  { es: "Equipo operativo local: guías, conductores, jefes de hotel y coordinadores de eventos. La parte que hace que todo suceda en destino.",
                 en: "Local operations team: guides, drivers, hotel managers and event coordinators. The crew that makes everything happen on the ground.",
                 fr: "Équipe opérationnelle locale : guides, chauffeurs, responsables d'hôtel et coordinateurs d'événements. Ceux qui font que tout se passe sur le terrain." } },
    ],
  },
  values: {
