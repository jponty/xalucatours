...
const COPY = {
  ...
  reasons: {
    ...
    items: [
      { icon: Headphones, title: { es: "Asistencia en viaje 24/7", en: "24/7 assistance during your trip", fr: "Assistance en voyage 24h/24 et 7j/7" },
        body: { es: "Mientras estás de viaje, te ayudamos ante cualquier necesidad o incidencia relacionada con tu itinerario. La oficina y la atención comercial mantienen su horario habitual.",
                en: "While you are travelling, we help with any need or incident related to your itinerary. Our office and customer service retain their regular opening hours.",
                fr: "Pendant votre voyage, nous vous aidons pour tout besoin ou incident lié à votre itinéraire. Nos bureaux et notre service commercial conservent leurs horaires habituels." } },
