    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-6 md:px-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
        ...
        <button
          ...
          className="group w-full overflow-hidden bg-black text-left shadow-[0_32px_80px_-24px_rgba(0,0,0,.8)]"
        >
          <span className="relative block aspect-video overflow-hidden">
            ...
            />
            <span className="absolute inset-0 bg-gradient-to-t from-black/45 via-black/10 to-black/25" aria-hidden="true" />
          ...
          <span className="flex items-center justify-between gap-5 border-t border-white/10 px-5 py-3 sm:px-6 sm:py-4">
            <span className="font-serif-x text-xl leading-snug sm:text-2xl">{pick(COPY.film.title, lang)}</span>
