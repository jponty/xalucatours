/* ============================================================
   ...
   `author` is a plain name; `quote` and `origin` are trilingual.
   All traveller origins are Spanish cities only — consistent with
   the day-specific testimonials on the trip pages.
============================================================ */
