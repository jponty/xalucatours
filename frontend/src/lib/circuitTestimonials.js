/* ============================================================
   ...
   quote = trilingual object; author / origin = strings.
============================================================ */
export const CIRCUIT_TESTIMONIALS = {
  sahara: [
    ...
    { rating: 5, author: "Javier R.", origin: "Madrid",
      quote: {
  ...
  imperial: [
    { rating: 5, author: "Anne D.", origin: "Lyon",
      quote: {
    ...
    { rating: 5, author: "Sofía & Pablo", origin: "Sevilla",
      quote: {
    ...
    { rating: 5, author: "Thomas K.", origin: "Berlín",
      quote: {
  ...
  atlas: [
    ...
    { rating: 5, author: "Marco & Giulia", origin: "Milán",
      quote: {
    ...
    { rating: 5, author: "Carla S.", origin: "Lisboa",
      quote: {
  ...
  kasbahs: [
    ...
    { rating: 5, author: "Hélène & Paul", origin: "París",
      quote: {
  ...
  north: [
    ...
    { rating: 5, author: "Lucas & Marta", origin: "A Coruña",
      quote: {
    ...
    { rating: 5, author: "Sarah W.", origin: "Ámsterdam",
      quote: {
  ...
  short: [
    ...
    { rating: 5, author: "Clara & Hugo", origin: "Bilbao",
      quote: {
    ...
    { rating: 5, author: "Émilie R.", origin: "Burdeos",
      quote: {
  ...
  adventure: [
    ...
    { rating: 5, author: "Nadia & Karim", origin: "Toulouse",
      quote: {
    ...
    { rating: 5, author: "David H.", origin: "Manchester",
      quote: {
