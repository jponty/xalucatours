...
export const SUR_GALLERIES = [
  // 1 · Patrimonio del sur · La ruta de las mil kasbahs
  {
    ...
    images: [
      ...
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Adobe del Valle del Drâa", "Drâa Valley adobe", "Pisé de la vallée du Drâa") },
  ...
  // 2 · Puerta del desierto · Merzouga y el Erg Chebbi
  {
    ...
    images: [
      ...
      { src: U("photo-1518684079-3c830dcef090"), caption: T("Caravana de dromedarios", "Camel caravan", "Caravane de dromadaires") },
      { src: U("photo-1547471080-7cc2caa01a7e"), caption: T("Té a la menta en el desierto", "Mint tea in the desert", "Thé à la menthe dans le désert") },
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Khamlia · pueblo gnaoua", "Khamlia · Gnawa village", "Khamlia · village gnaoua") },
  ...
  // 3 · Marrakech, Atlas & Sahara
  {
    ...
    accent: "#D97742",
    images: [
      { src: U("photo-1547471080-7cc2caa01a7e"), caption: T("Marrakech · ciudad roja", "Marrakech · the red city", "Marrakech · la ville rouge") },
      ...
      { src: U("photo-1518684079-3c830dcef090"), caption: T("Gargantas del Todra", "Todra Gorges", "Gorges du Todra") },
  ...
  // 4 · Marrakech & Essaouira
  {
    ...
    accent: "#5A7F9C",
    images: [
      { src: U("photo-1547471080-7cc2caa01a7e"), caption: T("Jemaa el-Fna al atardecer", "Jemaa el-Fna at sunset", "Jemaa el-Fna au coucher du soleil") },
      { src: U("photo-1556910103-1c02745aae4d"), caption: T("Essaouira · murallas portuguesas", "Essaouira · Portuguese ramparts", "Essaouira · remparts portugais") },
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Especias en el zoco de Marrakech", "Spices in the Marrakech souk", "Épices dans le souk de Marrakech") },
...
export const MARRUECOS_GALLERIES = [
  // Intro · Gran Sur · Una travesía total
  {
    ...
    accent: "#A07042",
    images: [
      { src: U("photo-1548013146-72479768bada"), caption: T("Fez · medina UNESCO", "Fez · UNESCO medina", "Fès · médina UNESCO") },
      { src: U("photo-1518684079-3c830dcef090"), caption: T("Cedros gigantes del Medio Atlas", "Giant cedars of the Middle Atlas", "Cèdres géants du Moyen Atlas") },
...
export const NORTE_GALLERIES = [
  // 1 · El alma del Norte (after first editorial block)
  {
    ...
    accent: "#C16542",
    images: [
      { src: U("photo-1548013146-72479768bada"), caption: T("Tenerías Chouara · Fez", "Chouara tanneries · Fez", "Tanneries Chouara · Fès") },
      ...
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Madraza Bou Inania", "Bou Inania Madrasa", "Médersa Bou Inania") },
  ...
  // 2 · Mosaico del Norte (after second editorial block)
  {
    ...
    accent: "#5A7F9C",
    images: [
      { src: U("photo-1548013146-72479768bada"), caption: T("Chefchaouen · pueblo azul", "Chefchaouen · blue town", "Chefchaouen · village bleu") },
      ...
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Asilah · murallas portuguesas", "Asilah · Portuguese ramparts", "Asilah · remparts portugais") },
      { src: U("photo-1556910103-1c02745aae4d"), caption: T("Mediterráneo del Rif", "Rif Mediterranean", "Méditerranée du Rif") },
    ],
  },
];
...
export const ESCAPADAS_GALLERIES = [
  // 0 · Desierto
  {
    ...
    images: [
      ...
      { src: U("photo-1518684079-3c830dcef090"), caption: T("Caravana de dromedarios", "Camel caravan", "Caravane de dromadaires") },
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Khamlia · ritmos gnaoua", "Khamlia · Gnawa rhythms", "Khamlia · rythmes gnaoua") },
      { src: U("photo-1547471080-7cc2caa01a7e"), caption: T("Té a la menta entre dunas", "Mint tea among the dunes", "Thé à la menthe au cœur des dunes") },
  ...
  // 1 · Atlas
  {
    ...
    images: [
      ...
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Pan en tannour", "Bread in the tannour", "Pain au tannour") },
    ],
  },
  // 2 · Fez
  {
    ...
    accent: "#A07042",
    images: [
      { src: U("photo-1548013146-72479768bada"), caption: T("Tenerías Chouara", "Chouara tanneries", "Tanneries Chouara") },
      { src: U("photo-1597212618440-806262de4f6b"), caption: T("Madraza Bou Inania", "Bou Inania Madrasa", "Médersa Bou Inania") },
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Callejuelas de Fez el-Bali", "Fez el-Bali alleys", "Ruelles de Fès el-Bali") },
  ...
  // 3 · Marrakech
  {
    ...
    accent: "#D97742",
    images: [
      { src: U("photo-1547471080-7cc2caa01a7e"), caption: T("Jemaa el-Fna", "Jemaa el-Fna", "Jemaa el-Fna") },
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Especias del zoco", "Souk spices", "Épices du souk") },
      ...
      { src: U("photo-1556910103-1c02745aae4d"), caption: T("Koutoubia al atardecer", "Koutoubia at sunset", "Koutoubia au coucher du soleil") },
  ...
  // 4 · Tánger
  {
    ...
    images: [
      ...
      { src: U("photo-1548013146-72479768bada"), caption: T("Chefchaouen · añil", "Chefchaouen · indigo", "Chefchaouen · indigo") },
      { src: U("photo-1547234935-80c7145ec969"),    caption: T("Tetuán · medina andalusí", "Tetouan · Andalusian medina", "Tétouan · médina andalouse") },
      { src: U("photo-1556910103-1c02745aae4d"), caption: T("Costa atlántica", "Atlantic coast", "Côte atlantique") },
      { src: U("photo-1570133435536-7ececf000ef6"), caption: T("Grutas de Hércules", "Caves of Hercules", "Grottes d'Hercule") },
      { src: U("photo-1604940500627-d3f44d1d21c6"), caption: T("Té a la menta sobre el estrecho", "Mint tea over the strait", "Thé à la menthe sur le détroit") },
    ],
  },
];
