...
export const HUB_MARRAKECH_LOOP = {
  ...
  programs: [
    ...
    { id: "mem-3-4", direction: "a", nights: "3n4d", accent: "#7C8B5C",
      image: "https://images.unsplash.com/photo-1570133435536-7ececf000ef6?auto=format&fit=crop&w=1800&q=85",
      link: "tourMarrakechLoop34",
      blurb: { es: "Escapada de 3 noches y 4 días desde Marrakech al desierto del Erg Chebbi, con noche extra en Kasbah Xaluca.",
               en: "3-night/4-day escape from Marrakech to the Erg Chebbi desert, with an extra night at Kasbah Xaluca.",
               fr: "Escapade de 3 nuits et 4 jours de Marrakech au désert de l'Erg Chebbi, avec une nuit supplémentaire au Kasbah Xaluca." } },
    { id: "mem-4-5", direction: "a", nights: "4n5d", accent: "#D97742",
      image: "https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&w=1800&q=85",
      link: "tourMarrakechLoop45",
      blurb: { es: "Escapada de 4 noches y 5 días desde Marrakech con día completo en el Alto Atlas Central y dos noches en Kasbah Xaluca.",
               en: "4-night/5-day escape from Marrakech with a full Central High Atlas day and two nights at Kasbah Xaluca.",
               fr: "Escapade de 4 nuits et 5 jours depuis Marrakech avec une journée complète dans le Haut Atlas Central et deux nuits au Kasbah Xaluca." } },
    { id: "mem-5-6", direction: "a", nights: "5n6d", accent: "#C16542",
      image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=1800&q=85",
      link: "tourMarrakechLoop56",
      blurb: { es: "Circuito completo de 5 noches y 6 días con dos noches en Marrakech, visita guiada a la Medina y bivouac en el Erg Chebbi.",
               en: "Full 5-night/6-day circuit with two nights in Marrakech, guided Medina tour and Erg Chebbi bivouac.",
               fr: "Circuit complet de 5 nuits et 6 jours avec deux nuits à Marrakech, visite guidée de la Médina et bivouac à l'Erg Chebbi." } },
    { id: "mem-6-7", direction: "a", nights: "6n7d", accent: "#D97742",
      image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1800&q=85",
      link: "tourMarrakechLoop67",
...
export const HUB_GRANSUR_FEZ_RAK = {
  ...
  programs: [
    { id: "fr-6-7",  direction: "a", nights: "6n7d",  accent: "#C16542", image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=1800&q=85", link: "tourFezRak67",  blurb: BLURB_FR(6,7)("Fez","Marrakech") },
    { id: "fr-7-8",  direction: "a", nights: "7n8d",  accent: "#D97742", image: "https://images.unsplash.com/photo-1547234935-80c7145ec969?auto=format&fit=crop&w=1800&q=85", link: "tourFezRak78",  blurb: BLURB_FR(7,8)("Fez","Marrakech") },
    { id: "fr-8-9",  direction: "a", nights: "8n9d",  accent: "#A07042", image: "https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&w=1800&q=85", link: "tourFezRak89",  blurb: BLURB_FR(8,9)("Fez","Marrakech") },
...
export const HUB_GRANSUR_FEZ_SIDIALI_RAK = {
  ...
  programs: [
    ...
    { id: "msf-7-8",  direction: "b", nights: "7n8d",  accent: "#C16542", image: "https://images.unsplash.com/photo-1570133435536-7ececf000ef6?auto=format&fit=crop&w=1800&q=85", link: "tourMarrakechSidialiFez78",  blurb: BLURB_SIDI(7,8)("Marrakech","Fez") },
    { id: "msf-8-9",  direction: "b", nights: "8n9d",  accent: "#D97742", image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1800&q=85", link: "tourMarrakechSidialiFez89",  blurb: BLURB_SIDI(8,9)("Marrakech","Fez") },
    { id: "msf-9-10", direction: "b", nights: "9n10d", accent: "#3A4A5F", image: "https://images.unsplash.com/photo-1547234935-80c7145ec969?auto=format&fit=crop&w=1800&q=85", link: "tourMarrakechSidialiFez910", blurb: BLURB_SIDI(9,10)("Marrakech","Fez") },
  ],
};
...
export const HUB_GRANSUR_OUARZA_FEZ = {
  ...
  programs: [
    { id: "of-5-6", direction: "a", nights: "5n6d", accent: "#A07042", image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1800&q=85", link: "tourOzzSidialiFez56", blurb: BLURB_SIDI(5,6)("Ouarzazate","Fez") },
    { id: "of-6-7", direction: "a", nights: "6n7d", accent: "#D97742", image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=1800&q=85", link: "tourOzzSidialiFez67", blurb: BLURB_SIDI(6,7)("Ouarzazate","Fez") },
    { id: "of-7-8", direction: "a", nights: "7n8d", accent: "#C16542", image: "https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&w=1800&q=85", link: "tourOzzSidialiFez78", blurb: BLURB_SIDI(7,8)("Ouarzazate","Fez") },
    ...
    { id: "fo-7-8", direction: "b", nights: "7n8d", accent: "#3A4A5F", image: "https://images.unsplash.com/photo-1570133435536-7ececf000ef6?auto=format&fit=crop&w=1800&q=85", link: "tourFezSidialiOuarzazate78", blurb: BLURB_SIDI(7,8)("Fez","Ouarzazate") },
  ],
};
...
export const HUB_NORTE_CIUDADES_IMPERIALES = {
  ...
  programs: [
    ...
    { id: "ci-6-7",    direction: "a", nights: "6n7d", accent: "#5A6B4F", image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=1800&q=85", link: "tourCiudadesImperiales67", blurb: BLURB_CI(6, 7) },
    ...
    { id: "cirf-7-8",  direction: "b", nights: "7n8d", accent: "#3A4A5F", image: "https://images.unsplash.com/photo-1597212618440-806262de4f6b?auto=format&fit=crop&w=1800&q=85", link: "tourCiudadesImperialesRif78", blurb: BLURB_CI_RIF(7, 8) },
  ],
};
...
export const HUB_ATLAS_DESIERTO_FEZ = {
  ...
  programs: [
    { id: "of-5-6", direction: "a", nights: "5n6d", accent: "#C16542", image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=1800&q=85", link: "tourOzzSidialiFez56", blurb: BLURB_AF(5, 6, "Ouarzazate", "Fez") },
