...
/* ============================================================
   Erg Chebbi → Marrakech · 5 noches / 6 días.
   Reutiliza por completo los días EM existentes — añade un día
   intermedio de Khamlia/Rissani entre el bivouac y el cruce
   del Atlas hacia Marrakech.
============================================================ */

export const PROGRAM_EM_56 = {
  routeId: "tourErgMarrakech56",
  duration_key: "em5n6d",
  duration: { es: "5 noches / 6 días", en: "5 nights / 6 days", fr: "5 nuits / 6 jours" },
  prices: { low: 1290, mid: 1490, high: 1690, premium: 1990 },
  reverse: true,
  ...
  details: {
    includes: {
      es: [
        "Dos noches en Kasbah Xaluca en Erfoud en media pensión",
        "Una noche en Erg Chebbi en bivouac de lujo en media pensión",
        "Una noche en Hotel Xaluca Dades 4* en media pensión",
        "Una noche en Marrakech en Riad u Hotel 5* en alojamiento y desayuno",
        "Picnic en el desierto el día 2",
        "Excursión en dromedario en el Erg Chebbi",
        "Vehículo 4x4 con chófer del día 2 al día 5",
        "Visita guiada por la Medina de Marrakech con guía local",
        "Visitas a la Kasbah de Aït Ben Haddou y al Palacio de la Bahía",
        "Transfers de aeropuerto en Errachidia y Marrakech",
      ...
      en: [
        "Two nights at Kasbah Xaluca in Erfoud, half board",
        "One night in Erg Chebbi at a luxury bivouac, half board",
        "One night at Hotel Xaluca Dades 4*, half board",
        "One night in Marrakech in a Riad or 5* Hotel, bed and breakfast",
        "Desert picnic on day 2",
        "Camel ride in the Erg Chebbi",
        "Private 4x4 with driver from day 2 to day 5",
        "Guided walking tour of the Marrakech Medina with local guide",
        "Visits to the Aït Ben Haddou Kasbah and the Bahia Palace",
        "Airport transfers in Errachidia and Marrakech",
        "Vehicle fuel",
      ...
      fr: [
        "Deux nuits au Kasbah Xaluca à Erfoud en demi-pension",
        "Une nuit à l'Erg Chebbi en bivouac de luxe en demi-pension",
        "Une nuit à l'Hôtel Xaluca Dadès 4* en demi-pension",
        "Une nuit à Marrakech en Riad ou Hôtel 5* en logement et petit déjeuner",
        "Pique-nique dans le désert le jour 2",
        "Balade à dromadaire à l'Erg Chebbi",
        "Véhicule 4x4 avec chauffeur du jour 2 au jour 5",
        "Visite guidée de la Médina de Marrakech avec guide local",
        "Visites de la Kasbah d'Aït Ben Haddou et du Palais de la Bahia",
        "Transferts aéroport à Errachidia et Marrakech",
    ...
    excludes: {
      es: [
        "Bebidas",
        "Comidas de mediodía excepto el picnic indicado",
        "Cenas en Marrakech",
        "Extras personales",
        "Vuelos",
      ...
      en: [
        "Drinks",
        "Lunches except the stated picnic",
      ...
      fr: [
        "Boissons",
        "Déjeuners sauf le pique-nique indiqué",
        "Dîners à Marrakech",
        "Extras personnels",
        "Vols",
    ...
    notes: {
      es: [
        ...
        "Habitaciones dobles y triples · Suplemento individual 335 €",
        "Descuentos para niños disponibles (consultar)",
        "Posibles cambios de Riad según disponibilidad",
        ...
        "Actividades opcionales: Quads 70 € por vehículo · Spa y masajes en hoteles",
        "Seguro de cancelación opcional: 30 € por persona para viajes de hasta 10 días — debe contratarse al confirmar",
      ],
      en: [
        "Flight options: Royal Air Maroc, Vueling, Air Arabia, Ryanair",
        "Prices based on 4x4 occupancy — the cost is split between occupants",
        "Double and triple rooms · Single supplement €335",
        "Child discounts available on request",
        "Riad may change depending on availability",
        ...
        "Optional activities: Quads €70 per vehicle · Spa and massages at hotels",
      ...
      fr: [
        ...
        "Chambres doubles et triples · Supplément individuel 335 €",
        "Remises enfants disponibles sur demande",
        "Riad susceptible de changer selon disponibilité",
        "Guides locaux susceptibles d'être partagés en haute saison",
        "Chauffeurs hispanophones limités — réserver à l'avance",
        "Passeport valable au moins 3 mois après la date de retour",
        "Activités en option : Quads 70 € par véhicule · Spa et massages en hôtel",
    ...
    terms: {
      es: [
        ...
        "Los vuelos y seguros tienen condiciones independientes y no son reembolsables",
      ],
      en: [
        "Compulsory booking form",
        "30% of the total at booking confirmation",
        ...
        "Flights and insurances have separate conditions and are non-refundable",
      ],
      fr: [
        ...
        "Les vols et assurances ont des conditions distinctes et ne sont pas remboursables",
      ],
    },
  },
};
