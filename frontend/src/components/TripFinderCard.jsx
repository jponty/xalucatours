  ...
  return (
    ...
    >
      ...
      >
        ...
        {chip && <span className="pointer-events-none absolute top-3 left-3 z-[4] inline-flex items-center gap-1.5 bg-[#C16542] text-[#FDFBF7] px-2.5 py-1.5 text-[9px] tracking-[0.2em] uppercase shadow-md">
        ...
        <span className="pointer-events-none absolute bottom-3 right-3 z-[4] bg-[#1A1513]/80 backdrop-blur-sm text-[#FDFBF7] px-2.5 py-1 text-[10px] tracking-[0.18em] uppercase tabular-nums">
      ...
      <div className="relative p-5">
        ...
        <h3 id={titleId} className="font-serif-x text-[#2C2621] text-xl leading-snug group-hover:text-[#C16542] transition-colors">{title}</h3>
        <p className="mt-2 inline-flex items-center gap-1.5 text-[12px] text-[#8A7C64] tracking-wide">
          {nodeName(trip.entry, lang)}<ArrowRight className="w-3 h-3" strokeWidth={1.8} />{nodeName(trip.exit, lang)}
        </p>
        <div className="mt-4 pt-4 border-t border-[#2C2621]/10 flex items-center justify-between gap-3">
          ...
          <Link to={href} className="relative z-[2] inline-flex min-h-11 items-center gap-1.5 text-[11px] tracking-[0.2em] uppercase text-[#2C2621] hover:text-[#C16542] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C16542]">
            {L("view")}<ArrowUpRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" strokeWidth={1.8} />
          </Link>
        </div>
      </div>
