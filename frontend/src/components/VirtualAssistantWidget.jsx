...
const COPY = {
  ...
  identifyBody: T("Déjanos tus datos para identificar tu consulta. Después, solo tendrás que elegir entre las opciones. Los campos marcados con * son obligatorios.", "Leave your details to identify your enquiry. Then simply choose from the options. Fields marked * are required.", "Laissez-nous vos coordonnées pour identifier votre demande. Choisissez ensuite parmi les options. Les champs marqués * sont obligatoires."),
