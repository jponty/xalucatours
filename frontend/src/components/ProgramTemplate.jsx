...
const LABELS = {
  es: {
    ...
    type_da: "Desierto + Atlas", type_ad: "Atlas + Desierto", type_frz: "Fez · Erg Chebbi · Marrakech", type_frm: "Marrakech · Erg Chebbi · Fez", type_me: "Marrakech · Atlas · Erg Chebbi", type_atlas: "Alto Atlas · Drâa", type_desierto: "Sáhara · Erg Chebbi",
  ...
  en: {
    ...
    type_da: "Desert + Atlas", type_ad: "Atlas + Desert", type_frz: "Fez · Erg Chebbi · Marrakech", type_frm: "Marrakech · Erg Chebbi · Fez", type_me: "Marrakech · Atlas · Erg Chebbi", type_atlas: "High Atlas · Drâa", type_desierto: "Sahara · Erg Chebbi",
  ...
  fr: {
    ...
    type_da: "Désert + Atlas", type_ad: "Atlas + Désert", type_frz: "Fès · Erg Chebbi · Marrakech", type_frm: "Marrakech · Erg Chebbi · Fès", type_me: "Marrakech · Atlas · Erg Chebbi", type_atlas: "Haut Atlas · Drâa", type_desierto: "Sahara · Erg Chebbi",
...
const QuickInfo = ({ t, vt, program, lang, variant }) => {
  const cards = [
    ...
    { Icon: Mountain, label: t.card_type,       value: variant === "frz" ? (t.type_frz || "Fez · Erg Chebbi · Marrakech") : variant === "frm" ? (t.type_frm || "Marrakech · Erg Chebbi · Fez") : variant === "me" ? (t.type_me || "Marrakech · Atlas · Erg Chebbi") : variant === "atlas" ? (t.type_atlas || "Alto Atlas · Drâa") : variant === "desierto" ? (t.type_desierto || "Sáhara · Erg Chebbi") : (variant === "ad" ? t.type_ad : t.type_da) },
