/* ============================================================
   ...
   Self-contained: reads the param, resolves the trip from the
   catalog, and renders nothing when there's no valid trip.
============================================================ */
      ...
      >
        ...
        <div className="min-w-0">
          ...
          <p className="font-serif-x text-lg md:text-xl text-[#2C2621] leading-snug mt-1">
            <span className="align-middle">{pick(trip.title, lang)}</span>
            <span className="text-[#5C5248] text-sm md:text-base align-middle">
              {" · "}{trip.nights + 1}{" "}{pick(DAYS, lang)}
            </span>
          </p>
